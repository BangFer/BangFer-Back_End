...
public class ReportService {
    ...
    public void reportUser(Long reporterId, Long reportedUserId, String content) {
        ...
        userReportRepository.save(UserReportDto.of(reporter, reportedUser, content));
        reportedUser.changeActivity(UserActivity.FLAGGED);
    }


    private User getReporterById(Long reporterId) {
